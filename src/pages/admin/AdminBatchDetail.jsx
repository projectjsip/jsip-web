...
import ModalDetailSubmissionAdmin from "../../components/Apply/ModalDetailSubmissionAdmin";
...
export default function AdminBatchDetail() {
  ...
  return (
    <>
      <Layout pageName="Detail Pengajuan Sekolah Terkirim">
                            ...
                            <Td>
                              <Stack direction="row" spacing="8px">
                                <ModalDetailSubmissionAdmin
                                  ...
                                  proofImage={sub?.submission_data?.proof_image}
                                  rewardAmount={
                                    sub?.submission_data?.reward_amount
                                  }
                                />
